...
class TestRTDP:
    def test_rtdp_tv_next(self, mocker):
        ...
        # context
        mockRTDP_TradingView = rtdp_tv.RTDPTradingView()
        ...
        mocker.patch.object(mockRTDP_TradingView, "_fetch_data", return_value=response)

        # action
        selection = mockRTDP_TradingView.next()
