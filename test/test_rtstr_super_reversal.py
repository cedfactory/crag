...
class StrategySuperReversal(rtstr.RealTimeStrategy):
    ...
    def get_df_buying_symbols(self):
        '''condition = (self.df_current_data['ema_short']['symbol'] >= self.df_current_data['ema_long']['symbol']
                    and self.df_current_data['super_trend_direction']['symbol'] == True
                    and self.df_current_data['ema_short']['symbol'] > self.df_current_data['low']['symbol']) == True
