class Trade:
    ...
    def get_csv_header(self):
        return ["transaction_id", "time", "buying_time","type", 'sell_id', "stimulus", "symbol", "buying_price","symbol_price", "net_size", "net_price", "buying_fees", "selling_fees", "gross_price", "transaction_roi%","remaining cash", "portfolio_value", "wallet_value", "wallet_roi%"]
