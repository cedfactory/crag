class Trade:
    ...
    def get_csv_row(self):
        return [self.id, self.time, self.buying_time,self.type, self.sell_id,self.stimulus, self.symbol, self.buying_price, self.symbol_price, self.net_size, self.net_price, self.buying_fee, self.selling_fee, self.gross_price, self.transaction_roi, self.cash, self.portfolio_value, self.wallet_value, self.wallet_roi]
