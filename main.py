...
def crag_simulation_scenario(strategy_name, start_date, end_date, interval, sl, tp, working_directory):
    ...
    if strategy_name == "superreversal":
        strategy = rtstr_super_reversal.StrategySuperReversal(params={"rtctrl_verbose": False, "sl": sl, "tp": tp, "suffix": strategy_suffix, "working_directory": working_directory})
    if strategy_name == "trix":
        strategy = rtstr_trix.StrategyTrix(params={"rtctrl_verbose": False, "sl": sl, "tp": tp, "suffix": strategy_suffix, "working_directory": working_directory})
    if strategy_name == "cryptobot":
        strategy = rtstr_cryptobot.StrategyCryptobot(params={"rtctrl_verbose": False, "sl": sl, "tp": tp, "suffix": strategy_suffix, "working_directory": working_directory})
    if strategy_name == "bigwill":
        strategy = rtstr_bigwill.StrategyBigWill(params={"rtctrl_verbose": False, "sl": sl, "tp": tp, "suffix": strategy_suffix, "working_directory": working_directory})
    if strategy_name == "vmc":
        strategy = rtstr_VMC.StrategyVMC(params={"rtctrl_verbose": False, "sl": sl, "tp": tp, "suffix": strategy_suffix, "working_directory": working_directory})
